...
const Calculator = () => {
  ...
  const calculateSolar = async () => {
    ...
    const COST_PER_KW_FLAT = 60000;
    const COST_PER_KW_PITCHED = 60000;
    const COST_PER_KW_TERRACE = 60000;
    ...
    let costPerkW = COST_PER_KW_FLAT;
    if (roofType === "pitched") costPerkW = COST_PER_KW_PITCHED;
    else if (roofType === "terrace") costPerkW = COST_PER_KW_TERRACE;

    const systemAmount = systemSize_kW * costPerkW;
  ...
  return (
    <div className="home-page">
      <section
        ...
        style={{ backgroundImage: `url(${solarHouse})` }}
      >
      ...
      <section id="calculator" className="calculator-hero-overlay">
        <div className="calculator-card">
          <div className="calculator-left">
            ...
            {successMsg && <p style={{ color: "green", marginTop: "1rem", fontWeight: "600" }}>{successMsg}</p>}
          </div>
